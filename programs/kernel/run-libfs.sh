...
ln816 "$OUT/LIBFS" "$OUT/hdr.o" "$OUT/t.o" "$OUT/fat32.o" "$OUT/kfs.o" "$OUT/kexec.o" "$OUT/kmem.o" "$OUT/gosh.o" "$OUT/console.o" "$OUT/ccur.o" "$OUT/font.o" "$OUT/smc.o" "$OUT/exec.o" "$OUT/fontcp.o" "$OUT/tab.o" "$OUT/kirq.o" || exit 1
