...
ln816 "$OUT/SHTEST" "$OUT/hdr.o" "$OUT/t.o" "$OUT/shell.o" "$OUT/fat32.o" "$OUT/kmem.o" "$OUT/kfs.o" "$OUT/console.o" "$OUT/font.o" "$OUT/smc.o" "$OUT/exec.o" "$OUT/fontcp.o" "$OUT/ccursor.o" || exit 1
